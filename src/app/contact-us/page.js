              ...
              <div className="mb-8 grid grid-cols-1 md:grid-cols-2 gap-1">
                <div className="flex items-center">
                  <div className="bg-[#E8EDFF] rounded-full flex items-center gap-3">
                    <div className="h-12 w-12 bg-[#fff] rounded-full flex items-center justify-center">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#323E7E]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
