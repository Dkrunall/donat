  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-[#F8F7FF] shadow-[0_-2px_5px_rgba(0,0,0,0.05)] md:hidden z-50 p-2 m-2 rounded-full">
      <div className="flex justify-around items-center">
        <Link href="/" onClick={handleNavigation} className={`relative flex flex-col items-center py-1 ${isActive('/') ? 'text-[#6C5DD3]' : 'text-gray-500'}`}>
        ...
        <button onClick={toggleAboutUsMenu} className={`relative flex flex-col items-center py-1 ${isActive('/about-us-trigger') ? 'text-[#6C5DD3]' : 'text-gray-500'}`}>
          <div className="w-6 h-6 flex items-center justify-center">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`w-5 h-5 ${isActive('/about-us-trigger') ? 'text-[#6C5DD3]' : 'text-gray-400'}`}>
              <path d="M12 2L2 7l10 5 10-5-10-5z"></path>
              <path d="M2 17l10 5 10-5"></path>
              <path d="M2 12l10 5 10-5"></path>
            </svg>
          </div>
          <span className={`text-xs mt-1 ${isActive('/about-us-trigger') ? 'text-[#6C5DD3]' : 'text-gray-400'}`}>About Us</span>
          {isActive('/about-us-trigger') && <div className="absolute bottom-[-4px] left-1/2 transform -translate-x-1/2 w-6 h-1 bg-[#3F3D56] rounded-t-sm"></div>}
        </button>
      ...
      {isAboutUsMenuOpen && (
        <div className="absolute bottom-full left-0 right-0 mb-2 p-3 bg-[#F8F7FF] shadow-lg rounded-xl border border-gray-200">
          <div className="grid grid-cols-2 gap-3">
            <Link href="/who-we-are" onClick={handleNavigation} className="bg-white p-4 rounded-2xl shadow flex flex-col justify-between relative h-24">
              <span className="text-base font-bold text-[#3F3D56]">About Us</span>
            ...
            <Link href="/wall-of-love" onClick={handleNavigation} className="bg-white p-4 rounded-2xl shadow flex flex-col justify-between relative h-24">
              <span className="text-base font-bold text-[#3F3D56]">Wall of Love</span>
              <div className="absolute bottom-3 right-3">
                <div className="w-6 h-6 bg-black rounded-full flex items-center justify-center">
                  <svg className="w-4 h-4 text-white" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M9 5l7 7-7 7"></path></svg>
                </div>
            ...
            <Link href="/media-and-highlights" onClick={handleNavigation} className="bg-white p-4 rounded-2xl shadow flex flex-col justify-between relative h-24">
              <span className="text-base font-bold text-[#3F3D56]">Media & Highlights</span>
              <div className="absolute bottom-3 right-3">
                <div className="w-6 h-6 bg-black rounded-full flex items-center justify-center">
                  <svg className="w-4 h-4 text-white" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M9 5l7 7-7 7"></path></svg>
                </div>
      ...
      {isWhatWeDoMenuOpen && (
        <div className="absolute bottom-full left-0 right-0 mb-2 p-3 bg-[#F8F7FF] shadow-lg rounded-xl border border-gray-200">
          <div className="grid grid-cols-2 gap-3">
            <Link href="/babu-ki-rasoi" onClick={handleNavigation} className="bg-white p-4 rounded-2xl shadow flex flex-col justify-between relative h-24">
            ...
            <Link href="/capp" onClick={handleNavigation} className="bg-white p-4 rounded-2xl shadow flex flex-col justify-between relative h-24">
      ...
      {isMenuOpen && (
        <div className="absolute bottom-full left-0 right-0 mb-2 p-3 bg-[#F8F7FF] shadow-lg rounded-xl border border-gray-200">
          <div className="grid grid-cols-2 gap-3">
            <Link href="/join-us" onClick={handleNavigation} className="bg-white p-4 rounded-2xl shadow flex flex-col justify-between relative h-24">
            ...
            <Link href="/contact-us" onClick={handleNavigation} className="bg-white p-4 rounded-2xl shadow flex flex-col justify-between relative h-24">
            ...
            <Link href="/resources" onClick={handleNavigation} className="bg-white p-4 rounded-2xl shadow flex flex-col justify-between relative h-24">
            ...
            <Link href="/our-impact" onClick={handleNavigation} className="bg-white p-4 rounded-2xl shadow flex flex-col justify-between relative h-24">
