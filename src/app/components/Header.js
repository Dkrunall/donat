        ...
        <div className="absolute right-14 top-24 w-[1000px] bg-white rounded-3xl shadow-lg p-8 z-50">
          ...
          <div className="flex items-center gap-5 h-80">
            <div className="w-1/2 space-y-6 border border-[#E3E3E3] rounded-2xl p-4">
              <Link href="/" className={`block text-[16px] px-6 py-2 rounded-lg ${isActive('/') && !showWhatWeDo && !showGetInvolved ? 'bg-[#39447B] text-white' : 'text-[#39447B] hover:text-white hover:bg-[#39447B]'}`}>Home</Link>
              <Link href="/who-we-are" className={`block text-[16px] px-6 py-2 rounded-lg ${isActive('/who-we-are') && !showWhatWeDo && !showGetInvolved ? 'bg-[#39447B] text-white' : 'text-[#39447B] hover:text-white hover:bg-[#39447B]'}`}>Who We Are</Link>
              <Link 
                href="#" 
                onClick={(e) => {
                  e.preventDefault();
