  ...
  return (
    <>
      <div className="p-1.5 md:p-1.5">
        ...
        {/* Hero Section */}
        <div className="info min-h-[700px] md:h-[90vh] w-full bg-[url(/capp.png)] bg-center bg-cover rounded-3xl flex flex-col justify-center -mt-10 relative overflow-hidden">
