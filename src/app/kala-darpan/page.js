  ...
  return (
    <>
      <div className="px-1.5 md:px-1.5">
        ...
        {/* Hero Section */}
        <div className="info min-h-[700px] md:h-[90vh] w-full bg-[url(/kdm.png)] bg-center bg-cover rounded-3xl flex flex-col justify-center -mt-0 md:-mt-10 relative overflow-hidden">
